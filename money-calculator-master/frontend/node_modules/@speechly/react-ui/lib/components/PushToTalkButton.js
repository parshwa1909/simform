...
var PushToTalkButton = function (_a) {
    ...
    var _o = (0, react_1.useState)(react_client_1.ClientState.Disconnected), icon = _o[0], setIcon = _o[1];
    ...
    (0, react_1.useEffect)(function () {
        ...
        setIcon(clientState);
        if (clientState >= react_client_1.ClientState.Connected) {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            switch (_a) {
                                case react_client_1.ClientState.Disconnected: return [3 /*break*/, 2];
                            }
                            return [3 /*break*/, 7];
                        case 2:
                        ...
                        case 8:
                            ...
                            if (!buttonStateRef.current.holdListenActive) return [3 /*break*/, 12];
                            buttonStateRef.current.wasListening = client.isListening();
                            if (!!client.isListening()) return [3 /*break*/, 12];
                            _b.label = 9;
                        case 9:
                        ...
                        case 13: throw Error('No Speechly client (are you using Speechly in non-browser environment?)');
